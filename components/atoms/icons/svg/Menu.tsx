...
const Menu: FC<React.HTMLProps<SVGAElement>> = ({...props}) => {
  return (
    <Root {...props as any} className="menu-root" width="30" height="23" viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg">
